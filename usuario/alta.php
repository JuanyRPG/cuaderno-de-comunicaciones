...
$password_2 = MD5($_POST['repetir_clave']);
...
if($password == $password_2 ){
    ...
    if($resultado->num_rows > 0){
        ...
        $alta = "INSERT INTO tbl_usuario(nombres,apellidos,email,password,usuario)VALUES('$nombres','$apellidos','$email','$password','$usuario')";
